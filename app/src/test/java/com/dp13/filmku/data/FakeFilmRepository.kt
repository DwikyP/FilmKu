...
private val localDataSource: LocalDataSource, private val appExecutors: AppExecutors): FilmDataSource {
    ...
    override fun insertFavoriteMovie(favoriteMovie: FavoriteMovieEntity) = localDataSource.insertFavoriteMovie(favoriteMovie)

    override fun deleteFavoriteMovie(favoriteMovie: FavoriteMovieEntity) = localDataSource.deleteFavoriteMovie(favoriteMovie)


    override fun insertFavoriteTvShow(favoriteTvShow: FavoriteTvShowEntity) = localDataSource.insertFavoriteTvShow(favoriteTvShow)

    override fun deleteFavoriteTvShow(favoriteTvShow: FavoriteTvShowEntity) = localDataSource.deleteFavoriteTvShow(favoriteTvShow)
